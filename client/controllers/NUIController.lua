...
-- RD UI compatibility callbacks (new UI -> original VORP core/events)
RegisterNUICallback('DropItemMoney', NUIService.RDDropMoney)
RegisterNUICallback('DropItemGold', NUIService.RDDropGold)
RegisterNUICallback('DropItemRoll', NUIService.RDDropRoll)
RegisterNUICallback('DropItemStandard', NUIService.RDDropStandard)
RegisterNUICallback('DropItemWeapon', NUIService.RDDropWeapon)
RegisterNUICallback('DropItemAdvanced', NUIService.RDDropAdvanced)
RegisterNUICallback('SaveInventoryLayout', NUIService.RDSaveInventoryLayout)
RegisterNUICallback('SaveHotbar', NUIService.RDSaveHotbar)
RegisterNUICallback('SaveHotbarPosition', NUIService.RDSaveHotbarPosition)
RegisterNUICallback('RequestGroundDrops', NUIService.RDRequestGroundDrops)
RegisterNUICallback('TakeFromGroundDrop', NUIService.RDTakeFromGroundDrop)
RegisterNUICallback('requestHandCraftingRecipes', NUIService.RDRequestHandCraftingRecipes)
RegisterNUICallback('handCraftingExecute', NUIService.RDHandCraftingExecute)
RegisterNUICallback('inventorySaddle', NUIService.RDInventorySaddle)
RegisterNUICallback('rdClothesOpen', NUIService.RDClothesOpen)
RegisterNUICallback('rdClothesAction', NUIService.RDClothesAction)
RegisterNUICallback('rdInventoryUiNotify', NUIService.RDUiNotify)
RegisterNUICallback('addWeaponAttachment', NUIService.RDAddWeaponAttachment)
RegisterNUICallback('removeWeaponAttachment', NUIService.RDRemoveWeaponAttachment)
RegisterNUICallback('inspection', NUIService.RDWeaponInspect)
RegisterNUICallback('removeBullets', NUIService.RDRemoveBullets)
RegisterNUICallback('setWeaponAmmoType', NUIService.RDSetWeaponAmmoType)
RegisterNUICallback('reloadWeapon', NUIService.RDReloadWeapon)
